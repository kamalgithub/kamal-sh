...
export const securityCopy: SecurityCopy = {
	...
	reportingEmailLeadIn: 'Email ',
	reportingBetween: ', or see ',
	reportingSecurityTxtLabel: 'security.txt',
	reportingTrailer: ' for the machine-readable version of the same contact.'
};
