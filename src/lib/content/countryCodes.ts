import type { CountryCallingCode } from './countryCodes.types';

// Sourced from the dr5hn/countries-states-cities-database dataset (ISO 3166-1 + E.164
// calling codes), sorted alphabetically by name for a scannable <select>. One entry
// (Bouvet Island) was dropped — its source dial code was junk data (an uninhabited
// territory with no real phone system in the first place). Multiple countries sharing a
// dial code (e.g. US/Canada both '1') is expected and correct under E.164, not a bug.
export const countryCallingCodes: CountryCallingCode[] = [
	{ iso2: 'AF', dialCode: '93', name: 'Afghanistan' },
	{ iso2: 'AX', dialCode: '358', name: 'Aland Islands' },
	{ iso2: 'AL', dialCode: '355', name: 'Albania' },
	{ iso2: 'DZ', dialCode: '213', name: 'Algeria' },
	{ iso2: 'AS', dialCode: '1', name: 'American Samoa' },
	{ iso2: 'AD', dialCode: '376', name: 'Andorra' },
	{ iso2: 'AO', dialCode: '244', name: 'Angola' },
	{ iso2: 'AI', dialCode: '1', name: 'Anguilla' },
	{ iso2: 'AQ', dialCode: '672', name: 'Antarctica' },
	{ iso2: 'AG', dialCode: '1', name: 'Antigua and Barbuda' },
	...
	{ iso2: 'BB', dialCode: '1', name: 'Barbados' },
	...
	{ iso2: 'BM', dialCode: '1', name: 'Bermuda' },
	{ iso2: 'BT', dialCode: '975', name: 'Bhutan' },
	{ iso2: 'BO', dialCode: '591', name: 'Bolivia' },
	{ iso2: 'BQ', dialCode: '599', name: 'Bonaire, Sint Eustatius and Saba' },
	...
	{ iso2: 'KY', dialCode: '1', name: 'Cayman Islands' },
	...
	{ iso2: 'CW', dialCode: '599', name: 'Curaçao' },
	{ iso2: 'CY', dialCode: '357', name: 'Cyprus' },
	{ iso2: 'CZ', dialCode: '420', name: 'Czech Republic' },
	{ iso2: 'CD', dialCode: '243', name: 'Democratic Republic of the Congo' },
	{ iso2: 'DK', dialCode: '45', name: 'Denmark' },
	{ iso2: 'DJ', dialCode: '253', name: 'Djibouti' },
	{ iso2: 'DM', dialCode: '1', name: 'Dominica' },
	{ iso2: 'DO', dialCode: '1', name: 'Dominican Republic' },
	...
	{ iso2: 'FJ', dialCode: '679', name: 'Fiji Islands' },
	...
	{ iso2: 'TF', dialCode: '262', name: 'French Southern Territories' },
	...
	{ iso2: 'GD', dialCode: '1', name: 'Grenada' },
	{ iso2: 'GP', dialCode: '590', name: 'Guadeloupe' },
	{ iso2: 'GU', dialCode: '1', name: 'Guam' },
	...
	{ iso2: 'HM', dialCode: '672', name: 'Heard Island and McDonald Islands' },
	{ iso2: 'HN', dialCode: '504', name: 'Honduras' },
	{ iso2: 'HK', dialCode: '852', name: 'Hong Kong S.A.R.' },
	...
	{ iso2: 'JM', dialCode: '1', name: 'Jamaica' },
	...
	{ iso2: 'MO', dialCode: '853', name: 'Macau S.A.R.' },
	...
	{ iso2: 'IM', dialCode: '44', name: 'Man (Isle of)' },
	...
	{ iso2: 'MS', dialCode: '1', name: 'Montserrat' },
	...
	{ iso2: 'MP', dialCode: '1', name: 'Northern Mariana Islands' },
	...
	{ iso2: 'PS', dialCode: '970', name: 'Palestinian Territory Occupied' },
	...
	{ iso2: 'PN', dialCode: '870', name: 'Pitcairn Island' },
	{ iso2: 'PL', dialCode: '48', name: 'Poland' },
	{ iso2: 'PT', dialCode: '351', name: 'Portugal' },
	{ iso2: 'PR', dialCode: '1', name: 'Puerto Rico' },
	...
	{ iso2: 'SH', dialCode: '290', name: 'Saint Helena' },
	{ iso2: 'KN', dialCode: '1', name: 'Saint Kitts and Nevis' },
	{ iso2: 'LC', dialCode: '1', name: 'Saint Lucia' },
	{ iso2: 'PM', dialCode: '508', name: 'Saint Pierre and Miquelon' },
	{ iso2: 'VC', dialCode: '1', name: 'Saint Vincent and the Grenadines' },
	{ iso2: 'BL', dialCode: '590', name: 'Saint-Barthelemy' },
	{ iso2: 'MF', dialCode: '590', name: 'Saint-Martin (French part)' },
	...
	{ iso2: 'SX', dialCode: '1721', name: 'Sint Maarten (Dutch part)' },
	...
	{ iso2: 'SJ', dialCode: '47', name: 'Svalbard and Jan Mayen Islands' },
	...
	{ iso2: 'BS', dialCode: '1', name: 'The Bahamas' },
	{ iso2: 'GM', dialCode: '220', name: 'The Gambia' },
	...
	{ iso2: 'UM', dialCode: '1', name: 'United States Minor Outlying Islands' },
	{ iso2: 'UY', dialCode: '598', name: 'Uruguay' },
	{ iso2: 'UZ', dialCode: '998', name: 'Uzbekistan' },
	{ iso2: 'VU', dialCode: '678', name: 'Vanuatu' },
	{ iso2: 'VA', dialCode: '379', name: 'Vatican City State (Holy See)' },
	{ iso2: 'VE', dialCode: '58', name: 'Venezuela' },
	{ iso2: 'VN', dialCode: '84', name: 'Vietnam' },
	{ iso2: 'VG', dialCode: '1', name: 'Virgin Islands (British)' },
	{ iso2: 'VI', dialCode: '1', name: 'Virgin Islands (US)' },
	{ iso2: 'WF', dialCode: '681', name: 'Wallis and Futuna Islands' },
	{ iso2: 'EH', dialCode: '212', name: 'Western Sahara' },
	{ iso2: 'YE', dialCode: '967', name: 'Yemen' },
	{ iso2: 'ZM', dialCode: '260', name: 'Zambia' },
	{ iso2: 'ZW', dialCode: '263', name: 'Zimbabwe' }
];

/** India first (Kamal's own country/timezone), then the rest alphabetically — the most
 *  likely default for this site's visitors, without hardcoding it as a separate default. */
export const countryCallingCodesForSelect: CountryCallingCode[] = [
	...countryCallingCodes.filter((c) => c.iso2 === 'IN'),
	...countryCallingCodes.filter((c) => c.iso2 !== 'IN')
];
