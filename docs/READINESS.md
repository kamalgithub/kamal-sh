...
| G4  | Test gaps: `formatDate.ts`, `buildCareerTimeline.ts` still have no specs (`buildCommands.ts` and `scripts/lib/*` got theirs 2026-09-09) | Add small pure-function specs                                                                                                                                                                                                                 |
